...
export default function Template13({ data }) {
  ...
  const displayImage = imageUrl || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1000&q=80';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 to-pink-500 text-white font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      <div>
        <div className="w-full h-80 md:h-[500px] px-4 pt-4">
          <img src={displayImage} onError={(e) => { e.target.onerror = null; e.target.src='https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1000&q=80'; }} alt={shopName} className="w-full h-full object-cover rounded-xl shadow-xl border border-gray-200/50" />
        </div>
        <div className="max-w-3xl mx-auto py-20 px-8 text-center bg-white/10 backdrop-blur-md rounded-[3rem] mt-12 mb-12 border border-white/20 shadow-2xl mt-8 relative z-10 bg-white/90 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-10 border border-white/50 -mt-24 mx-4 md:mx-auto">
          <h1 className="text-5xl font-black text-white text-center tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">{shopName}</h1>
          ...
          <div className="flex justify-center">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-white text-purple-600 rounded-full px-8 py-4 font-bold transition-all hover:-translate-y-1 hover:shadow-xl hover:bg-slate-800 rounded-full text-lg w-full sm:w-auto shadow-lg">
