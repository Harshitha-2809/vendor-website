...
export default function Template5({ data }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-100 font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      <div>
        ...
        <div className="max-w-3xl mx-auto py-24 px-6 text-center mt-8 relative z-10 bg-white/90 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-10 border border-white/50 -mt-24 mx-4 md:mx-auto">
          <h1 className="text-4xl font-semibold text-white text-center tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">{shopName}</h1>
          ...
          <div className="flex justify-center">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-white text-black rounded-lg px-8 py-4 font-bold transition-all hover:-translate-y-1 hover:shadow-xl hover:bg-slate-800 rounded-full text-lg w-full sm:w-auto shadow-lg">
