...
export default function Template11({ data }) {
  ...
  return (
    <div className="min-h-screen bg-orange-50 text-orange-900 font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      <div className="pt-20 px-4 min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-md mx-auto my-12 bg-white rounded-3xl shadow-md p-8 border border-orange-100 text-center relative z-10">
          ...
          <h1 className="text-3xl font-bold text-orange-600">{shopName}</h1>
          ...
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-orange-500 text-white rounded-full mt-8 w-full shadow-lg p-4 rounded-xl">
