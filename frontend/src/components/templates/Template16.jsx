...
export default function Template16({ data }) {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      <div>
        ...
        <div className="max-w-5xl mx-auto py-24 px-8 text-center mt-8 relative z-10 bg-white/90 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-10 border border-white/50 -mt-24 mx-4 md:mx-auto">
          <h1 className="text-6xl font-black mb-4 tracking-tighter text-center tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">{shopName}</h1>
