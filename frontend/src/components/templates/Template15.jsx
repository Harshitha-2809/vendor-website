...
export default function Template15({ data }) {
  ...
  return (
    <div className="min-h-screen bg-[#2c2c2c] text-gray-300 font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden">
      <div>
        ...
        <div className="max-w-3xl mx-auto my-12 border-4 border-red-600 p-10 bg-[#1a1a1a] text-center shadow-2xl mt-8 relative z-10 bg-white/90 backdrop-blur-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.05)] rounded-[2.5rem] p-10 border border-white/50 -mt-24 mx-4 md:mx-auto">
          <h1 className="text-4xl font-serif text-red-500 text-center uppercase tracking-widest text-center tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600">{shopName}</h1>
          ...
          <p className="text-xl font-serif text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto text-center">{description}</p>
          ...
          <div className="flex justify-center">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-red-600 text-white rounded-none uppercase tracking-wider px-8 py-4 font-bold transition-all hover:-translate-y-1 hover:shadow-xl hover:bg-slate-800 rounded-full text-lg w-full sm:w-auto shadow-lg">
